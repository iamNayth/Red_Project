...
<?php ob_start(); ?>
    ...
    <h2 class="mb-5"><a href="../public/index.php?page=sub_category" class="btn btn-secondary me-3">Retour</a>Modifier la sous-catégorie</h2>
        <form action="../public/index.php?page=validate_edit_subCategory&id=<?php echo $subcategorie['id']?>" method="POST">
